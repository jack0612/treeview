...
import { BlockableUI, PrimeNGConfig, PrimeTemplate,   TranslationKeys, TreeDragDropService, TreeNode } from 'primeng/api';
...
export class Tree implements OnInit, AfterContentInit, OnChanges, OnDestroy, BlockableUI {
     ...
     * @group Props
     */
    @Input('templateMap') templateMap: any;
    /**
    ...
    ngAfterContentInit() {
        ...
        (this.templates as QueryList<PrimeTemplate>).forEach((item) => {
            switch (item.getType()) {
                ...
                default:
                    this.templateMap[<any>item.name] = item.template;
                    break;
            }
        });
    }
