...
import { PrimeTemplate, PrimeNGConfig, OverlayService, SharedModule } from 'primeng/api';
import { OverlayModeType, ResponsiveOverlayOptions, OverlayOptions, OverlayOnBeforeShowEvent, OverlayOnShowEvent, OverlayOnBeforeHideEvent, OverlayOnHideEvent } from './overlayoptions';
import { VoidListener } from '../models/ts-helpers';
    ...
    template: `
        ...
        >
            ...
            >
                ...
                <ng-container *ngIf="contentTemplate" *ngTemplateOutlet="contentTemplate; context: { $implicit: { mode: overlayMode } }"></ng-container>
            </div>
        </div>
    `,
